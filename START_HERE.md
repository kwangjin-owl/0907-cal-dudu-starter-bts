...
- [✓] 로컬 모드: localStorage 기반, 역할 전환 가능
- [✓] Supabase 모드: Auth + RPC 호출 통합
- [✓] 에러 표시: 인증/조회/저장 오류 화면 표시
- [✓] 공통 시나리오: 2명 고객, 1명 어드민으로 완전 테스트
...
**테스트 환경:**
- Supabase 프로젝트: [0907-cal-dudu-starter-bts]
- 테스트 날짜: 2026-09-07
- 테스트 사용자: C01 (c01@test.com), C02 (c02@test.com), ADMIN (admin@test.com)
